...
COPY ./tomcat/index.jsp $CATALINA_HOME/webapps/ROOT
COPY ./tomcat/session.jsp $CATALINA_HOME/webapps/ROOT
COPY ./tomcat/web.xml $CATALINA_HOME/webapps/ROOT/WEB-INF
